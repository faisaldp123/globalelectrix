  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#F6F7FB] min-h-[270px] mb-4">
        <Link href={`/products/${encodeURIComponent(String(id))}`} onClick={handleProductDetails} aria-label={`View ${title}`}>
      ...
      >
        <Link href={`/products/${encodeURIComponent(String(id))}`}> {title} </Link>
      </h3>
